...
import com.android.laundrygo.viewmodel.SpecialTreatmentViewModel
...
fun SpecialTreatmentScreen(
    ...
    onCartClick: () -> Unit,
    viewModel: SpecialTreatmentViewModel = viewModel(
        factory = SpecialTreatmentViewModel.provideFactory(ServiceRepositoryImpl())
    )
) {
