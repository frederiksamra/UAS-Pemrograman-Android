...
data class SpecialTreatmentService(
    val title: String,
    val price: String
)
...
fun SpecialTreatmentScreen(
    ...
    val services = listOf(
        SpecialTreatmentService("Jas Spesial", "IDR 43.000/Pcs"),
        SpecialTreatmentService("Mantel Spesial", "IDR 30.000/Pcs"),
        SpecialTreatmentService("Gaun Pendek Spesial", "IDR 50.000/Pcs"),
        SpecialTreatmentService("Gaun Panjang Spesial", "IDR 27.000/Pcs")
    )

    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Perawatan Khusus") },
                navigationIcon = {
...
@Composable
private fun SpecialTreatmentCard(
    service: SpecialTreatmentService,
    ...
    Card(
        ...
        Row(
            ...
            Column(
                ...
                // Ukuran font judul sekarang konsisten, tidak lagi dari data
                Text(
                    text = service.title,
...
@Preview(showBackground = true, name = "SpecialTreatmentScreen")
@Composable
